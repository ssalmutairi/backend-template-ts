...
class TemplateClient {
  ...
  ): Promise<paths["/api/auth/login"]["post"]["responses"]["200"]["content"]["application/json"]> {
  ...
  async PostApiAuthLogout(
    config?: AxiosRequestConfig,
  ): Promise<paths["/api/auth/logout"]["post"]["responses"]["200"]["content"]["application/json"]> {
  ...
  async GetApiTemplate(
    query?: paths["/api/template/"]["get"]["parameters"]["query"],
    config?: AxiosRequestConfig,
  ): Promise<paths["/api/template/"]["get"]["responses"]["200"]["content"]["application/json"]> {
    const response = await this.axiosInstance.get("/api/template/", { params: query, ...config });
    return response.data;
  }

  // Axios Method for /api/template/ - POST
  async PostApiTemplate(
    data: paths["/api/template/"]["post"]["requestBody"]["content"]["application/json"],
    config?: AxiosRequestConfig,
  ): Promise<paths["/api/template/"]["post"]["responses"]["200"]["content"]["application/json"]> {
    const response = await this.axiosInstance.post("/api/template/", data, config);
    return response.data;
  }

  // Axios Method for /api/template/{id} - GET
  async GetApiTemplateById(
    id: string,
    config?: AxiosRequestConfig,
  ): Promise<paths["/api/template/{id}"]["get"]["responses"]["200"]["content"]["application/json"]> {
    const response = await this.axiosInstance.get(`/api/template/${id}`, config);
    return response.data;
  }

  // Axios Method for /api/template/{id} - PUT
  async PutApiTemplateById(
    id: string,
    data: paths["/api/template/{id}"]["put"]["requestBody"]["content"]["application/json"],
    config?: AxiosRequestConfig,
  ): Promise<paths["/api/template/{id}"]["put"]["responses"]["200"]["content"]["application/json"]> {
    const response = await this.axiosInstance.put(`/api/template/${id}`, data, config);
    return response.data;
  }

  // Axios Method for /api/template/{id} - DELETE
  async DeleteApiTemplateById(
    id: string,
    config?: AxiosRequestConfig,
  ): Promise<paths["/api/template/{id}"]["delete"]["responses"]["200"]["content"]["application/json"]> {
  ...
  async GetApiUsers(
    ...
    config?: AxiosRequestConfig,
  ): Promise<paths["/api/users/"]["get"]["responses"]["200"]["content"]["application/json"]> {
  ...
  async PostApiUsers(
    ...
    config?: AxiosRequestConfig,
  ): Promise<paths["/api/users/"]["post"]["responses"]["200"]["content"]["application/json"]> {
    const response = await this.axiosInstance.post("/api/users/", data, config);
    return response.data;
  }

  // Axios Method for /api/users/{id} - GET
  async GetApiUsersById(
    id: string,
    config?: AxiosRequestConfig,
  ): Promise<paths["/api/users/{id}"]["get"]["responses"]["200"]["content"]["application/json"]> {
    const response = await this.axiosInstance.get(`/api/users/${id}`, config);
    return response.data;
  }

  // Axios Method for /api/users/{id} - PUT
  async PutApiUsersById(
    id: string,
    data: paths["/api/users/{id}"]["put"]["requestBody"]["content"]["application/json"],
    config?: AxiosRequestConfig,
  ): Promise<paths["/api/users/{id}"]["put"]["responses"]["200"]["content"]["application/json"]> {
    const response = await this.axiosInstance.put(`/api/users/${id}`, data, config);
    return response.data;
  }

  // Axios Method for /api/users/{id} - DELETE
  async DeleteApiUsersById(
    id: string,
    config?: AxiosRequestConfig,
  ): Promise<paths["/api/users/{id}"]["delete"]["responses"]["200"]["content"]["application/json"]> {
    const response = await this.axiosInstance.delete(`/api/users/${id}`, config);
    return response.data;
  }

  // Axios Method for /api/users/reset-password - PUT
  async PutApiUsersResetpassword(
    data: paths["/api/users/reset-password"]["put"]["requestBody"]["content"]["application/json"],
    config?: AxiosRequestConfig,
  ): Promise<paths["/api/users/reset-password"]["put"]["responses"]["200"]["content"]["application/json"]> {
